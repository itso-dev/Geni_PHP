<script>
    ...
    $msg = "안녕하세요 ".$info['name']."님\r\ni.M 택시 '지니' 채용팀 입니다.\r\n면접 일정 변경이 완료되었습니다.\r\n\r\n- 지원 번호: ".$info['apply_num']."\r\n- 희망 근무지 : $location\r\n- 위치 : $apply_address\r\n- 운수사 연락처 : ".$l['phone']."\r\n- 교통 : $apply_subway\r\n- 변경 면접 일정 : $apply_date_val\r\n- 준비 서류\r\n① 이력서\r\n② 운전면허증 사본(1종 보통 이상)\r\n③ 운전경력 증명서(전체 경력)\r\n\r\n지원 정보 확인은 하단 링크에서 확인 하실 수 있습니다.\r\nhttps://genie.imforyou.co.kr/apply_completion.php?applyNo=".$info['apply_num']."\r\n\r\n지원해 주셔서 감사합니다.\r\n";
    ...
    */
    ...
    $_variables = array(
        ...
        'receiver_1' => $info['phone'],
        'recvname_1' => $info['name'],
        'subject_1' => "아이.엠 택시 '지니'",
        'emtitle_1' => '면접일정 및 제출서류 안내',
        'message_1' => "안녕하세요 ".$info['name']."님
i.M 택시 '지니' 채용팀 입니다.
신청하신 지니 채용 면접이 내일 ".$time."시에 진행 될 예정입니다.
...
"linkType": "WL",
"linkTypeName": "웹링크",
"linkPc": "https://genie.imforyou.co.kr/apply_completion.php?applyNo='.$info['apply_num'].'",
"linkMo" : "https://genie.imforyou.co.kr/apply_completion.php?applyNo='.$info['apply_num'].'"
}]
...
"linkMo" : "https://genie.imforyou.co.kr/apply_completion.php?applyNo='.$info['apply_num'].'"
    ...
    echo "location.href = '/apply_completion.php?applyNo=".$info['apply_num']."';";
    echo "}, 500);";
    echo "}catch(e){}";
    echo "</script>";
